...
export default function SettingsPage() {
    const { profile, user, updateProfile, signOut, connectGoogleCalendar } = useAuth();
        ...
        <div>
            ...
            <div className={s.contentCard} style={{ padding: 32, marginBottom: 24 }}>
                ...
                {!profile?.google_refresh_token ? (
                    /* No calendar connected yet → show connect button */
                    <div>
                        <div style={{ padding: '14px 18px', borderRadius: 10, background: '#f0f7ff', border: '1px solid #93c5fd', fontSize: '0.85rem', color: '#1e40af', lineHeight: 1.6, marginBottom: 14 }}>
                            ℹ️ Először össze kell kapcsolnod a Google Naptáradat. A gombra kattintva a Google kérni fogja, hogy engedélyezd a naptár olvasását.
                        </div>
                        <button
                        ...
                        >
                            ...
                            Google Naptár összekapcsolása
                        </button>
                    </div>
                ) : (
                    /* Calendar connected → show toggle */
                    <div>
